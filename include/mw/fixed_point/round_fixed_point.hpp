...
constexpr fp<wl, fl, sign, rm> round(fp<wl, fl, sign, rm> in)
{
	typedef typename fp<wl, fl_to, sign, rm>::int_type type;
...
template<long wl, long fl, typename sign, rounding_mode rm, long fl_to = fl>
constexpr fp<wl, fl, sign, rm> trunc(fp<wl, fl, sign, rm> in)
{
	typedef typename fp<wl, fl_to, sign, rm>::int_type type;
	constexpr type frac_mask = make_mask<type>(fl_to);
	return in.negative() ?
...
template<long wl, long fl, typename sign, rounding_mode rm, long fl_to = fl>
constexpr fp<wl, fl, sign, rm> ceil(fp<wl, fl, sign, rm> in)
{
	typedef typename fp<wl, fl_to, sign, rm>::int_type type;
	constexpr type frac_mask = make_mask<type>(fl_to);
...
template<long wl, long fl, typename sign, rounding_mode rm, long fl_to = fl>
constexpr fp<wl, fl, sign, rm> floor(fp<wl, fl, sign, rm> in)
{
	typedef typename fp<wl, fl_to, sign, rm>::int_type type;
	constexpr type frac_mask = make_mask<type>(fl_to);
	return 	((in.value() & frac_mask) ?
